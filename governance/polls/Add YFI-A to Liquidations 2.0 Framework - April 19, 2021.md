...
summary: This poll proposes system parameters which could be used to initialize YFI-A with the Liquidations 2.0 Framework.
discussion_link: https://forum.makerdao.com/t/yfi-a-liquidations-2-0-parameters/7502
...
# Poll: Add YFI-A to Liquidations 2.0 Framework - April 19, 2021
...
This poll allows the MakerDAO governance community to signal their support or opposition to adding YFI-A to the Liquidations 2.0 Framework in the Maker Protocol with the parameters below:
...
Please review the following [Risk Evaluation](https://forum.makerdao.com/t/yfi-a-liquidations-2-0-parameters/7502) containing information about YFI-A to inform your position before voting.

## Outcomes

**If the votes for the 'Yes' option exceed the votes for the 'No' option then the following actions will be taken:**

- YFI-A will be added to the Liquidations 2.0 System by a future executive vote as the Smart Contracts Team schedule allows.
