...
To express interest join <Link to={"https://chat.makerdao.com/channel/call-summaries "} icon={"rocketchat"}>#call-summaries</Link> in Rocketchat or comment on the <Link to= {"https://forum.makerdao.com/t/wanted-join-the-summary-team/4318"}>help wanted forum post</Link> and someone will reach out to you.
