...
Maker updated the Liquidations System, which was [approved and executed by Maker governance in April 2021](https://vote.makerdao.com/executive/6079bc39efe023001bfeb317?network=mainnet#proposal-detail). The importance and benefits of the updated Liquidations system, also known as Liquidations 2.0, is summarized in this [Maker Blog Post](https://blog.makerdao.com/the-liquidations-2-0-upgrade-executive-vote-is-live/). For a complete technical overview of the system, read the [Liquidations 2.0 Module documentation.](https://docs.makerdao.com/smart-contract-modules/dog-and-clipper-detailed-documentation)
