...
description: "How risk is categorized in the Maker Protocol"
---
...
Risk levers such as the Stability Fee, [Dai Savings Rate](/learn/Dai/dsr), and the collateral onboarding process can be used to influence both Vault and Dai holder behavior in order to facilitate a market equilibrium at \$1.
...
Another type of exogenous risk includes threats to the governance process. Social attacks or improper procedures might necessitate an [Emergency Shutdown](/learn/governance/emergency-shutdown) to preserve the legitimacy of MakerDAO.
