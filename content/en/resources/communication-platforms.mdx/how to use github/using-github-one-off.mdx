...
description: "A simple guide to GitHub by the MakerDAO Community."
...
On the GitHub Website, navigate to the repository you want to change. For example, [MakerDAO MIPs GitHub](https://github.com/makerdao/mips).
...
Go to your forked version of the repo and then the file you want to edit. For example, the [main README file](https://github.com/makerdao/mips/blob/master/README.md).
...
Clicking compare and pull request opens the full pull request page, including checks for merging and fields to explain the changes.
