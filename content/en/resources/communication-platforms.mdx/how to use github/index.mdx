...
description: "Two simple guides to GitHub by the MakerDAO Community."
...
MakerDAO uses [GitHub](https://github.com/) for hosting canonical information. It houses documentation and projects.

Take advantage of GitHub's robust graphic user interface (GUI) for Git; opening issues, and managing content files are the bulk of the work. MakerDAO uses a simple Git branching model, where one party manages the master branch and reviews all changes before adding them.
...
Below are two clear guides to GitHub by the MakerDAO Community.
...
2. [Fork](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) the repository you want to work on. For example, you may want to fork the [MakerDAO MIPs GitHub](https://github.com/makerdao/mips) repository.
...
<Button to="/resources/communication-platforms.mdx/how to use github/using-github-one-off/">
  One-off guide
</Button>

### For Ongoing Contributions

In order to successfully contribute more than simple changes, there is an [in-depth guide](/resources/communication-platforms.mdx/how to use github/using-github-ongoing/) and this TL;DR
...
<Button to="/resources/communication-platforms.mdx/how to use github/using-github-ongoing/">
  In-depth guide
</Button>
...
*The tutorials in [Getting Started 101](#getting-started-101) below are a great place to start. They cover many of GitHub's functions. Set aside some time to go through them.*
...
Click the links in this section for short animated examples of key useful GitHub actions. Alternatively, scroll through this [GIF gallery](https://imgur.com/a/eeO7OJM) to quickly see all the expedient demos below in one place.
...
- Most projects use issues to track work.
...
- Consider this screenshot example of a [Pull Request](github-fixing-a-commit.png) with multiple annotations, commits, and requests for changes.
