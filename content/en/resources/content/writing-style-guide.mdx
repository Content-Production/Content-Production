...
description: "The Writing Style Guide summarizes the standards and best practices Writers should follow when contributing to community resources."
---

# Writing Style Guide

The Writing Style Guide summarizes the standards and best practices Writers should follow when contributing to community resources.

<Callout icon="press" secondary>


In addition to this guide, Writers are encouraged to study the [contributor resources](/resources/content/) before starting work on community projects.
...
MakerDAO community materials should cater to readers who are unfamiliar with the Maker system. Writers should also assume that their readers have tight schedules and short attention spans.
